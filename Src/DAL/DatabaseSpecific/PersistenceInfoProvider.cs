...
namespace TournamentCalendarDAL.DatabaseSpecific
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		{
			this.AddElementMapping("InfoServiceEntity", @"TournamentCalendar", @"dbo", "InfoService", 20, 0);
			this.AddElementFieldMapping("InfoServiceEntity", "City", "City", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 0);
			this.AddElementFieldMapping("InfoServiceEntity", "Comments", "Comments", false, "NVarChar", 255, 0, 0, false, "", null, typeof(System.String), 1);
			this.AddElementFieldMapping("InfoServiceEntity", "ConfirmedOn", "ConfirmedOn", true, "DateTime", 0, 0, 0, false, "", null, typeof(System.DateTime), 2);
			this.AddElementFieldMapping("InfoServiceEntity", "CountryId", "CountryId", true, "NVarChar", 2, 0, 0, false, "", null, typeof(System.String), 3);
			this.AddElementFieldMapping("InfoServiceEntity", "Email", "Email", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 4);
			this.AddElementFieldMapping("InfoServiceEntity", "FirstName", "FirstName", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 5);
			this.AddElementFieldMapping("InfoServiceEntity", "Gender", "Gender", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 6);
			this.AddElementFieldMapping("InfoServiceEntity", "Guid", "Guid", true, "NVarChar", 64, 0, 0, false, "", null, typeof(System.String), 7);
			this.AddElementFieldMapping("InfoServiceEntity", "Id", "Id", false, "Int", 0, 10, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int32), 8);
			this.AddElementFieldMapping("InfoServiceEntity", "LastName", "LastName", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 9);
			this.AddElementFieldMapping("InfoServiceEntity", "Latitude", "Latitude", true, "Float", 0, 38, 0, false, "", null, typeof(System.Double), 10);
			this.AddElementFieldMapping("InfoServiceEntity", "Longitude", "Longitude", true, "Float", 0, 38, 0, false, "", null, typeof(System.Double), 11);
			this.AddElementFieldMapping("InfoServiceEntity", "MaxDistance", "MaxDistance", true, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 12);
			this.AddElementFieldMapping("InfoServiceEntity", "ModifiedOn", "ModifiedOn", false, "DateTime", 0, 0, 0, false, "", null, typeof(System.DateTime), 13);
			this.AddElementFieldMapping("InfoServiceEntity", "Street", "Street", false, "NVarChar", 255, 0, 0, false, "", null, typeof(System.String), 14);
			this.AddElementFieldMapping("InfoServiceEntity", "SubscribedOn", "SubscribedOn", false, "DateTime", 0, 0, 0, false, "", null, typeof(System.DateTime), 15);
			this.AddElementFieldMapping("InfoServiceEntity", "Title", "Title", false, "NVarChar", 30, 0, 0, false, "", null, typeof(System.String), 16);
			this.AddElementFieldMapping("InfoServiceEntity", "UserName", "UserName", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 17);
			this.AddElementFieldMapping("InfoServiceEntity", "UserPassword", "UserPassword", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 18);
			this.AddElementFieldMapping("InfoServiceEntity", "ZipCode", "ZipCode", false, "NVarChar", 6, 0, 0, false, "", null, typeof(System.String), 19);
		}
